...
class ArbitrageService:
    ...
    def _calculate_adquisition_rate(self, rate_1: BinanceCurrencyResponse, rate_2: BinanceCurrencyResponse) -> float:
        """
    ...
    def _calculate_remesas_customer_price(self, adquisition_rate: float, reveneu_rate: float = 1.08) -> float:
        """
    ...
    async def get_today_remesas_price(self, reveneu_rate: float = 1.08) -> ArbitrageResponse:
        ...
        ven_to_peru_adquisition_rate = self._calculate_adquisition_rate(
            rate_1=fiat_pair.fiat_2_p2p_sell,
            rate_2=fiat_pair.fiat_1_p2p_buy
        )
